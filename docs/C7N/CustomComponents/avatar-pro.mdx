...
sidebar_position: 10
tags: [头像, AvatarPro]
keywords: [头像, AvatarPro]
---

<Author count={3600} publish="2023-05-11 18:40:00" edit="2023-05-23 18:53:00" />
...
| 参数     | 类型                               | 说明                                                                                        | 默认值      |
| :------- | :--------------------------------- | :------------------------------------------------------------------------------------------ | :---------- |
| children | `string` 或者 `React.ReactElement` | <Highlight>可选</Highlight> 子节点，递归查找 `string` 类型的子节点并显示 (`Emoji` 字符规范) | -           |
...
> 此问题 [(#1530)](https://github.com/open-hand/choerodon-ui/issues/1530) 已得到回复，预计将于 `1.6.0` 之后的版本修复。
