...
<Author count={3000} publish="2023-05-11 18:40:00" update="2023-05-23 18:53:00" />
...
> 此问题 [(#1530)](https://github.com/open-hand/choerodon-ui/issues/1530) 已得到回复，预计将在后续版本中修复(`1.6.2` 暂未修复)。
