...
<Author count={3000} publish="2023-5-11 18:40" update="2023-6-7 11:31" />
...
> 此问题 [(#1530)](https://github.com/open-hand/choerodon-ui/issues/1530) 已得到回复，预计将在后续版本 (`>=1.6.3-alpha.3`) 修复。
