...
<Author cost={4} publish="2024-1-11 23:25" update="2024-4-24 0:35" />
...
const lovQueryConfig = getConfig('lovQueryAxiosConfig')({ dataSet, params, data });
```
